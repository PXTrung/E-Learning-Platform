...
import CourseDetailBanner from "./components/courseDetail/banner/CourseDetailBanner";
import Comment from "./components/courseDetail/comment/Comment";
import CoursesList from "./components/courseDetail/courseListAccordion/CoursesList";
        ...
        <div className="course-detail-infor">
          <div className="course-detail-content-container">
            <div>
              ...
              <div className="courseDescription">{data?.data.description}</div>
            </div>
            <div>
